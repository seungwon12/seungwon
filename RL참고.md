# Github 내 검색 기능으로 발견한 github 들 
* 검색어 : reinforcement trade, deep stock 등)
* 업데이트 날짜 : 2019년 이후, 오래 된 github의 경우 라이브러리가 매우 다를 수 있으므로


## 현재 검증되지 않은 github

- value-based-deep-reinforcement-learning-trading-model-in-pytorch
https://github.com/mokpolar/value-based-deep-reinforcement-learning-trading-model-in-pytorch

- deep_reinforcement_learning_stock_trading_bot
https://github.com/mokpolar/deep_reinforcement_learning_stock_trading_bot

- AutomatedStockTrading-DeepQ-Learning
https://github.com/mokpolar/AutomatedStockTrading-DeepQ-Learning

- Stock-Prediction-Models
https://github.com/mokpolar/Stock-Prediction-Models

- deep-RL-trading
https://github.com/mokpolar/deep-RL-trading

- q-trader
https://github.com/mokpolar/q-trader

- Reinforcement-Learning-Stock-Trader
https://github.com/mokpolar/Reinforcement-Learning-Stock-Trader

- rl-trader
https://github.com/mokpolar/rl-trader

- Event-Driven-Stock-Prediction-using-Deep-Learning
https://github.com/mokpolar/Event-Driven-Stock-Prediction-using-Deep-Learning
...
- 파이썬과 케라스를 이용한 딥러닝/강화학습 주식투자 원 저자 github
https://github.com/mokpolar/rltrader
